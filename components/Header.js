...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 2, name: locale.NAV.EVENTS, to: '/events', show: true },
    { id: 3, name: locale.NAV.TEAM, to: '/team', show: true },
    { id: 4, name: locale.NAV.POLICY, to: '/policy', show: true },

    { id: 5, name: locale.NAV.RSS, to: '/feed', show: false, external: true },
...
export default function Header ({ navBarTitle, fullWidth }) {
  ...
  const resolveFavicon = fallback => !fallback && dark ? '/favicon.ico' : '/favicon.ico'
